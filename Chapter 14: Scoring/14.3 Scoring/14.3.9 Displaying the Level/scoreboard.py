...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        self.ai_game = ai_game  # Store the ai_game reference
    ...
    def prep_high_score(self):
        ...
        current_mode = self.ai_game.current_mode
        high_score = round(self.stats.high_scores[current_mode], -1)
    ...
    def check_high_score(self):
        ...
        current_mode = self.ai_game.current_mode
        if self.stats.score > self.stats.high_scores[current_mode]:
