...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.play_button = Button(
            self, "Play", button_colour=(0, 135, 0)
        )  # Green Play button
        self.easy_button = Button(
            self, "Easy", position=(1370, 1200), button_colour=(144, 238, 144)
        )  # Easy button
        self.medium_button = Button(
            self, "Medium", position=(1620, 1200), button_colour=(255, 215, 0)
        )  # Medium button
        self.hard_button = Button(
            self, "Hard", position=(1870, 1200), button_colour=(255, 69, 0)
        )  # Hard button
