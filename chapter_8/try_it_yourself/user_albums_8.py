# 8-8. User Albums: Start with your program from Exercise 8-7. Wirte a while loop that allows
#                   users to enter an album's artist and title. Once you have that information,
#                   call make_album() with the user's input and pritn the dictionary that's created.
